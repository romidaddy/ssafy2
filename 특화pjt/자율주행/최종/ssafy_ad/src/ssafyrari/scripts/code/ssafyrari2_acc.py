...
class pure_pursuit :
    def __init__(self):
        ...
        self.vel_planning = velocityPlanning(self.target_velocity/3.6, 0.8)
        ...
        while not rospy.is_shutdown():
            ...
            # print(self.is_odom , self.is_status)
    ...
    def path_angle_diff(self, ):
        ...
        first_local_deg = atan2(self.path.poses[1].pose.position.y - self.current_position.y, self.path.poses[1].pose.position.x - self.current_position.x) * (180 / pi)
    ...
    def calc_pure_pursuit(self,):
        ...
        if self.is_gps:
            ...
            # translation = [self.path.poses[0].pose.position.x,self.path.poses[0].pose.position.y]
            translation = [0,0]
        ...
        for num,i in enumerate(self.path.poses) :
            ...
            if local_path_point[0]>0 :
                ...
                if dis>= self.lfd :
                    ...
                    break
        # else:
        #     now_point = self.path.poses[0].pose.position
        #     # print(self.path.poses[0].pose.position)
        #     for num,i in enumerate(self.path.poses) :
        #         path_point=i.pose.position
        #         local_path_point = [now_point.x-path_point.x,now_point.y-path_point.y]
        ...
        # if self.is_look_forward_point and temp:
        #     print(local_path_point)
        #     if local_path_point[0] < 0:
        #         theta=atan2(local_path_point[1],local_path_point[0])-pi
...
class velocityPlanning:
    ...
    def curvedBaseVelocity(self, gloabl_path, point_num):
        ...
        for i in range(len(gloabl_path.poses) - point_num, len(gloabl_path.poses)-7):
            out_vel_plan.append(10)

        for i in range(len(gloabl_path.poses) - 7, len(gloabl_path.poses)):
