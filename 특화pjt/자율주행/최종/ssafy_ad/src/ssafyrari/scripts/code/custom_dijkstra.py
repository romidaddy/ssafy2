...
class dijkstra_path_pub :
    def __init__(self):
        ...
        rospy.Subscriber('/start', GPS, self.init_callback)
        rospy.Subscriber('/goal', GPS, self.goal_callback)
        # rospy.loginfo(self.is_goal_pose)
        while True:
    ...
    def init_callback(self,msg):
        ...
        if long == 0 and lat == 0:
            ...
            x = xy_zone[0] - 313008.558198
            y = xy_zone[1] - 4161698.628368
