...
class dijkstra_path_pub :
    def __init__(self):
        ...
        # rospy.Subscriber('/startGPS', GPSMessage, self.init_callback)
        # rospy.Subscriber('/arriveGPS', GPSMessage, self.goal_callback)
...
class Realtime_listener:
    def __init__(self):
        ...
        user_ref = db.collection(u'User').document(u'User1').get().to_dict()
